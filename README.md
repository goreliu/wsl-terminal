...
1. [Download here](https://github.com/goreliu/wsl-terminal/releases), or run `bash -c "wget https://github.com/goreliu/wsl-terminal/releases/download/v0.8.8/wsl-terminal-0.8.8.7z && 7z x wsl-terminal-0.8.8.7z"` in `cmd.exe` or WSL.
